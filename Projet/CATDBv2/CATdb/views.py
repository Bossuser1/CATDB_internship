...
def ficheexperiment(request):
    ...
    if getdata(requete)[1][0][0]=='RNA-Seq':
        ...
        return render(request,'CATdb/ficheexperiment.html',{'sortage_link':sortage_link,'experiment':experiment_id,'project':project_id})
    else:
